...
public class ImageCache {
    ...
    private void init(ImageCacheParams cacheParams) {
        ...
        if (mCacheParams.memoryCacheEnabled) {
            ...
            mMemoryCache = new LruCache<String, CircularDrawable>(mCacheParams.memCacheSize) {
                ...
                protected void entryRemoved(boolean evicted, String key,
                                            CircularDrawable oldValue, CircularDrawable newValue) {
                 ...
                 */
                @Override
                protected int sizeOf(String key, CircularDrawable value) {
     ...
     */
    public void addBitmapToCache(String data, CircularDrawable value) {
     ...
     */
    public CircularDrawable getBitmapFromMemCache(String data) {
        //BEGIN_INCLUDE(get_bitmap_from_mem_cache)
        CircularDrawable memValue = null;
    ...
    /**
     * Get the size in bytes of a bitmap in a CircularDrawable. Note that from Android 4.4 (KitKat)
     ...
     */
    @TargetApi(VERSION_CODES.KITKAT)
    public static int getBitmapSize(CircularDrawable value) {
