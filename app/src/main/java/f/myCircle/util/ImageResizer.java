...
public class ImageResizer extends ImageWorker {
     ...
     *
     * @param uri The URI pointing to the image data
     * @param reqWidth The requested width of the resulting bitmap
     * @param reqHeight The requested height of the resulting bitmap
     * @param cache The ImageCache used to find candidate bitmaps for use with inBitmap
     * @return A bitmap sampled down from the original with the same aspect ratio and dimensions
    ...
    public static Bitmap decodeSampledBitmapFromUri(Context context, Uri uri,
        ...
        final BitmapFactory.Options options = new BitmapFactory.Options();
        options.inJustDecodeBounds = true;
        BitmapFactory.decodeStream(openDisplayPhoto(context, uri), null, options);
        ...
        return BitmapFactory.decodeStream(openDisplayPhoto(context, uri));
    }
